...
# =============================================
# ========== [신규] 관리자 토큰 및 AI 모델 설정 ==========
# =============================================
ADMIN_TOKEN_HASH = "7677c1e67d477f43131129b8ce3ad62e2d84b1ec1eb74f81fd5457e8fac07d79" # 토큰 암호화 처리
...
async def ws_endpoint(ws: WebSocket):
    ...
    try:
        ...
        # [수정] 로그 메시지 제거
        # print(f"WS connection closed for {user_id}: {type(e).__name__}")
        pass
