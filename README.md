...
- **최근 점수 기반 관리:** 관리자 패널은 평균이 아닌 사용자의 **최근 점수**를 기준으로 그룹 분류 및 모니터링을 수행합니다.
...
| **서버 저장 (해시)** | `b10a8db164e0754105b7a99be72e3fe57717b11d237b6139369527e04b40706d` | `main.py`에서 검증용 (노출 안 됨) |
